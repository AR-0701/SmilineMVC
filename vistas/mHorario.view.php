...
.ui-datepicker-header {
    background: #ffffff; /* Fondo de la cabecera */
...
.ui-datepicker-prev:hover, .ui-datepicker-next:hover {
    background:white; /* Fondo al pasar el cursor */
    color: #ffffff; /* Color del ícono al pasar el cursor */
}

/* Días de la semana */
.ui-datepicker thead {
    background: #00A99D; /* Fondo */
...
.ui-datepicker-calendar td:hover {
    background: #13cdbd; /* Fondo al pasar el cursor */
    color: white; /* Texto blanco */
}

/* Día seleccionado */
.ui-datepicker-calendar .ui-state-active {
    background: #00b3b3; /* Fondo rojo */
    color: white; /* Texto blanco */
    font-weight: bold;
}
...
.ui-datepicker select {
    background: #ffffff; /* Fondo select */
    color: #333; /* Texto */
        ...
        <main class="main">
            ...
            <div class="schedule-container">
                <div class="form-container">
                    <form id="formulario-horarios" action="logica/modificarHorario.php" method="POST">

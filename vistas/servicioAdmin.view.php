        ...
        <nav class="sidebar">
            <div class="sidebar-nav">
                ...
                <div class="sidebar-menu">
                    ...
                    <a href="../public/servicioAdmin.php" class="sidebar-menu-item active">
    ...
    <div class="content-wrapper">
        <main class="container py-4">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-3">
                    <div class="card animate__animated animate__zoomIn">
                        <img src="../Imagenes/Se1.png" alt="Limpieza"
                ...
                <div class="col-md-3">
                    <div class="card animate__animated animate__zoomIn">
                        <img src="../Imagenes/Se2.png" alt="Endodoncia"
                            class="animate__animated animate__pulse animate__infinite">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card animate__animated animate__zoomIn">
                        <img src="../Imagenes/Se3.png" alt="Resinas"
                            class="animate__animated animate__pulse animate__infinite">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card animate__animated animate__zoomIn">
                        <img src="../Imagenes/Se4.png" alt="Blanqueamiento"
                            class="animate__animated animate__pulse animate__infinite">
                    </div>
                </div>
            ...
            <div class="row text-center mt-4">
                ...
                <div class="col-md-3">
                    <div class="card animate__animated animate__zoomIn">
                        <img src="../Imagenes/Se5.png" alt="Extracciones"
                            class="animate__animated animate__pulse animate__infinite">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card animate__animated animate__zoomIn">
                        <img src="../Imagenes/Se6.png" alt="Cirugía"
                            class="animate__animated animate__pulse animate__infinite">
                    </div>
                </div>
                ...
                <div class="col-md-3 animate__animated animate__fadeInUp">
                    <div class="card">
                        <img src="../Imagenes/Se7.png" alt="Brackets"
                            class="animate__animated animate__pulse animate__infinite">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="card animate__animated animate__zoomIn">
                        <img src="../Imagenes/Se8.png" alt="General"
                            class="animate__animated animate__pulse animate__infinite">
                    </div>
                </div>
            </div>

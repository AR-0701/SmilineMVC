        ...
        <nav class="sidebar">
            <div class="sidebar-nav">
                ...
                <div class="sidebar-menu">
                    ...
                    <a href="../public/registroAsis.php" class="sidebar-menu-item active">
                        <svg class="sidebar-menu-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <main class="main-content">
            <div class="page-header fade-in">
                <div class="page-title">
                    ...
                    <!-- Justo debajo del título "Registro de Asistentes" -->
                    <?php if (isset($_GET['success']) && $_GET['success'] == 1): ?>
                        <div class="alert alert-success fade-in">Asistente registrado exitosamente</div>
                    <?php endif; ?>

                    <?php if (isset($errorGeneral)): ?>
                        <div class="alert alert-danger fade-in"><?php echo htmlspecialchars($errorGeneral); ?></div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="card fade-in delay-1">
                ...
                <div class="card-body fade-in delay-2">
                    ...
                    <form id="registrationForm" method="POST"
                        action="../controladores/controladorRAsis.php?action=procesarRegistro"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="password-checklist">
                                    ...
                                    <ul>
                                        ...
                                        <li id="check-uppercase"><i class="far fa-circle"></i> Al menos una letra mayúscula
                                        </li>
                            ...
                            <div class="col-md-6">
                                ...
                                <button type="submit" class="btn-primary-custom">
                                    <i class="fas fa-user-plus me-2"></i>Registrar Asistente
                                </button>
                            </div>
                        </div>
                    </form>
                ...
                <!-- Script para mostrar errores específicos del servidor -->
                <?php if (!empty($errores)): ?>
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            <?php foreach ($errores as $campo => $mensaje): ?>
                                const input<?php echo ucfirst($campo); ?> = document.querySelector('[name="<?php echo $campo; ?>"]');
                                if (input<?php echo ucfirst($campo); ?>) {
                                    input<?php echo ucfirst($campo); ?>.classList.add('is-invalid');
                                    const errorElement = document.getElementById('<?php echo $campo; ?>Error') || input<?php echo ucfirst($campo); ?>.nextElementSibling;
                                    if (errorElement) errorElement.textContent = '<?php echo addslashes($mensaje); ?>';
                                }
                            <?php endforeach; ?>
                        });
                    </script>
